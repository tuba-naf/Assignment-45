...
let book: {Title:string,Author:string}={Title:"Constitutional & Political History of Pakistan",Author:"Hamid Khan"}
...
if(alien_color1=="green"){console.log("player just earned 5 points for shooting the alien")}
...
if(aliencolor=="green"){console.log("player earned 5 points.")}
else if(aliencolor=="yellow"){console.log("player earned 10 points.")}
else if(aliencolor=="red"){console.log("player earned 15 points.")}
//Yellow Alien Version:
aliencolor="yellow"
if(aliencolor=="green"){"player earned 5 points."}
else if(aliencolor=="yellow"){console.log("player earned 10 points.")}
else if(aliencolor=="red"){console.log("player earned 15 points.")}
//Red Alien Version:
aliencolor="red"
...
let favorite_fruits:string[]=["apple","banana","orange","grapes","mango","pomegrante","strawberry","coconut"]
...
if(favorite_fruits.includes("pomegrante")){console.log("I really like pomegrante")}
if(favorite_fruits.includes("strawberry")){console.log("I really like strawberry")}
if(favorite_fruits.includes("coconut")){console.log("I really like coconut")}
console.log()
...
usernames.forEach((usernames)=>{if (usernames=="Admin"){console.log("Hello admin, would you like to see a status report?")}
...
let userlist=[]
if(userlist.length==0){console.log("We need to find some users")}
else {console.log("Greet Users")}
console.log()
...
new_users.forEach((newuser)=>{if(current_users.some((currentUser)=>currentUser.toLowerCase()===newuser.toLowerCase())){console.log(` ${newuser} already exists in current_users.`)}
...
numbers.forEach((number)=>{let suffix=""; 
if(number===1){suffix="st"}
else if(number===2){suffix="nd"}
else if(number===3){suffix="rd"}
else if(number===4){suffix="th"}
else if(number===5){suffix="th"}
else if(number===6){suffix="th"}
else if(number===7){suffix="th"}
else if(number===8){suffix="th"}
else if(number===9){suffix="th"}
...
function make_tshirt(size:string,message:string){console.log(`The size of the T-shirt is ${size} and the message printed on the T-shirt is ${message}.`) }
...
function make_tshirt1(size:string,message:string="I love typescript"){console.log(`Make a ${size} shirt with ${message} printed on it.`)}
make_tshirt1("Large")
make_tshirt1("medium")
...
function make_album(artistname:string,albumtitle:string){return `${artistname} made an album ${albumtitle}.`}
...
let magicians:string[]=["Ali","Sara","Zainab"]
...
let magicians1:string[]=["Ali","Sara","Zainab"]
function make_great(magicians1:string[]){return magicians1.map(magician1=>`${magician1},The great magician`)}
...
function make_great1(magicians2:string[]){return magicians2.map(magicians2=>`The great ${magicians2}.`)}
console.log(make_great1(magicians2))
let greatmagicians:string[]=make_great1([...magicians2])//stored in a separate array
function show_magicians1(magicians:string[]){magicians.forEach(magician => {console.log(magician)
});}
...
function sandwich(...items:string[]){return `Make a sandwich with ${items.join(",")}.`}
...
function makecar(Manufacturer:string,Model:string,...arg:[string,any][])
{let car:{[key:string]:any}={Manufacturer, Model}; arg.forEach(([key, value])=> (car[key]=value));
    return car}
